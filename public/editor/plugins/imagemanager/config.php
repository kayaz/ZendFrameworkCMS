<?php
	...
	$mcImageManagerConfig['general.user_friendly_paths'] = false;
	$mcImageManagerConfig['general.encrypt_paths'] = false;
	...
	$mcImageManagerConfig['general.language'] = "pl"; // en, sv
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../files/upload/'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,rar,pdf,doc,docx,txt,zip,rtf,odt,mp4";
	...
	$mcImageManagerConfig['thumbnail.width'] = "130"; // px
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,rar,pdf,doc,docx,txt,zip,rtf,odt,mp4";
	...
	$mcImageManagerConfig['SessionAuthenticator.user_key'] = "admin";
	...
	$mcImageManagerConfig['ExternalAuthenticator.secret_key'] = "isLoggedIn";
